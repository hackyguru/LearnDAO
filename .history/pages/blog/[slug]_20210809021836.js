    ...
    <>
      ...
      <VStack>
        ...
        <HStack alignContent="right">
          <Button backgroundColor onClick={onOpen}>Vote YES</Button>
          <Button onClick={onOpen}>Vote NO</Button>
        </HStack>
        <br></br>
        <Text color="green.400">100% volume of votes find this useful</Text>
        <Text color="red">0% volume of votes don't find this to be useful</Text>
